<div>
    ...
    @section('modal-content')
        <form class="form-horizontal" action="{{ route('etudiant_professor') }}" method="POST">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="promotion" class="form-control" placeholder="promotion d'etudiant" required>
                </div>
                <div class="form-group">
